...
The assembler contains a fully-fledged import and export system quite similar to JavaScript. Import aliasing, glob imports, and block-scoped imports are all supported.
